...
var parkline1 = createSprite(windowWidth/2+50, windowHeight/2-320,15,160);
...
var playerCar = createSprite(windowWidth/2,windowHeight/2-200);
...
function draw() {
  ...
  if(gameState === level1Won){
    ...
    if(keyDown("space")&&gameState === level1Won){
      ...
      stroke("red");
      strokeWeight(2);
     text("GO BACK AND PLAY NEXT LEVEL ",windowWidth/2-165,wall3.y+300);
